...
class CloseOrders extends StatefulWidget {
  const CloseOrders({super.key});

  @override
  // ignore: no_logic_in_create_state
  _CloseOrdersState createState() => _CloseOrdersState();
}

class _CloseOrdersState extends State<CloseOrders> {
  _CloseOrdersState();
/*
    ...
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) => Padding(
          ...
          child: Dismissible(
            key: Key(userorders[index].id.toString()),
